...
while True:
    ...
    early_warning_start = datetime.time(19, 30) if use_non_school_evenings == False else datetime.time(20, 00)
    late_warning_start = datetime.time(19, 50) if use_non_school_evenings == False else datetime.time(20, 20)
    sleeping_start = datetime.time(20, 00) if use_non_school_evenings == False else datetime.time(20, 30)
    awake_start = datetime.time(6, 45) if use_non_school_mornings == False else datetime.time(8, 00)
    awake_warning_start = datetime.time(7, 30) if use_non_school_mornings == False else datetime.time(8, 45)
    awake_normal_start = datetime.time(8, 00) if use_non_school_mornings == False else datetime.time(9, 00)
